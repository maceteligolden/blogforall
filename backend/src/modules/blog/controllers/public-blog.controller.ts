...
export class PublicBlogController {
  ...
  getPublishedBlogs = async (req: Request, res: Response, next: NextFunction): Promise<void> => {
    ...
    try {
      ...
      // Log service call
      logger.info("Service call: getPublishedBlogs", {
        accessKeyId,
        userId,
      ...
      logger.info("Service response: getPublishedBlogs", {
        accessKeyId,
        userId,
      ...
      if (error instanceof ZodError) {
        logger.warn("Validation error in getPublishedBlogs", {
          accessKeyId,
          errors: error.errors,
          duration: `${duration}ms`,
        }, "PublicBlogController");
      ...
      logger.error("Error in getPublishedBlogs", error as Error, {
        accessKeyId,
  ...
  getCategories = async (req: Request, res: Response, next: NextFunction): Promise<void> => {
    ...
    try {
      ...
      // Log service call
      logger.info("Service call: getCategories", {
        accessKeyId,
        userId,
        tree,
        includeInactive,
      ...
      // Log service response
      logger.info("Service response: getCategories", {
        accessKeyId,
        userId,
  ...
  getBlogsByCategory = async (req: Request, res: Response, next: NextFunction): Promise<void> => {
    ...
    try {
      ...
      // Log service call
      logger.info("Service call: getBlogsByCategory", {
        accessKeyId,
        userId,
        categoryId,
        filters: validatedFilters,
      ...
      // Log service response
      logger.info("Service response: getBlogsByCategory", {
        accessKeyId,
        userId,
        categoryId,
        blogsCount: result.data.length,
      ...
      const duration = Date.now() - startTime;
      if (error instanceof ZodError) {
        logger.warn("Validation error in getBlogsByCategory", {
          accessKeyId,
      ...
      logger.error("Error in getBlogsByCategory", error as Error, {
        accessKeyId,
        userId: req.user?.userId,
        categoryId: req.params.categoryId,
        duration: `${duration}ms`,
  ...
  getPublishedBlogById = async (req: Request, res: Response, next: NextFunction): Promise<void> => {
    ...
    try {
      ...
      // Log service call
      logger.info("Service call: getPublishedBlogById", {
        accessKeyId,
        userId,
        blogId: id,
        method: req.method,
      ...
      if (blog.status !== "published") {
        logger.warn("Blog not published or not found", {
          accessKeyId,
          userId,
          blogId: id,
          status: blog.status,
      ...
      // Log service response
      logger.info("Service response: getPublishedBlogById", {
        accessKeyId,
        userId,
        blogId: id,
      ...
      const duration = Date.now() - startTime;
      logger.error("Error in getPublishedBlogById", error as Error, {
        accessKeyId,
        userId: req.user?.userId,
  ...
  getPublishedBlogBySlug = async (req: Request, res: Response, next: NextFunction): Promise<void> => {
    ...
    try {
      ...
      // Log service call
      logger.info("Service call: getPublishedBlogBySlug", {
        accessKeyId,
        userId,
        slug,
        method: req.method,
      ...
      // Log service response
      logger.info("Service response: getPublishedBlogBySlug", {
        accessKeyId,
        userId,
        slug,
      ...
      const duration = Date.now() - startTime;
      logger.error("Error in getPublishedBlogBySlug", error as Error, {
        accessKeyId,
        userId: req.user?.userId,
