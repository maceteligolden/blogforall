...
export const workspaceTracker = {
  ...
  created: (props?: WorkspaceEventProperties) => captureEvent(AnalyticsEvents.WORKSPACE_CREATED, props),
  ...
  deleted: (props?: WorkspaceEventProperties) => captureEvent(AnalyticsEvents.WORKSPACE_DELETED, props),

  updated: (props?: WorkspaceEventProperties) => captureEvent(AnalyticsEvents.WORKSPACE_UPDATED, props),
};
