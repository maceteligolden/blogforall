...
export const generationTracker = {
  ...
  confirmed: (props?: GenerationEventProperties) => captureEvent(AnalyticsEvents.GENERATION_CONFIRMED, props),
  ...
  retry: (props?: GenerationEventProperties) => captureEvent(AnalyticsEvents.GENERATION_RETRY, props),

  abandoned: (props?: GenerationEventProperties) => captureEvent(AnalyticsEvents.GENERATION_ABANDONED, props),

  blogSaved: (props?: GenerationEventProperties) => captureEvent(AnalyticsEvents.BLOG_SAVED, props),

  blogPublished: (props?: GenerationEventProperties) => captureEvent(AnalyticsEvents.BLOG_PUBLISHED, props),
};
