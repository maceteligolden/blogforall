...
import { Calendar, Plus, Clock, CheckCircle, XCircle, X, Edit, Trash2 } from "lucide-react";
      ...
      <div className="flex justify-between items-center mb-6">
        ...
        <div className="flex items-center gap-3">
          <Button
            ...
            onClick={() => router.push(`${SCHEDULED_BASE}/calendar`)}
          >
          ...
          <Button
            ...
            onClick={() => router.push(`${SCHEDULED_BASE}/new`)}
          >
                  ...
                  {(post.status === "pending" || post.status === "scheduled") && (
                    <>
                      <Button
                        ...
                        variant="outline"
                        className="border-gray-700 text-gray-300 hover:bg-gray-800"
                        onClick={() => router.push(`${SCHEDULED_BASE}/${post._id}/edit`)}
                      >
