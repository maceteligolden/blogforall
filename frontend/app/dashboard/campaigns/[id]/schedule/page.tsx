...
export default function SchedulePostPage() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    // Validate scheduled date is within campaign dates
    if (campaign) {
  ...
  const minDate = campaign ? new Date(campaign.start_date).toISOString().slice(0, 16) : today;
  const maxDate = campaign ? new Date(campaign.end_date).toISOString().slice(0, 16) : undefined;
    ...
    <div className="min-h-screen bg-black text-white">
      <div className="max-w-4xl mx-auto px-6 lg:px-8 py-6">
        ...
        <div className="mb-6">
          ...
          <p className="text-gray-400 mt-2">Schedule a blog post for campaign: {campaign.name}</p>
        </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex items-center justify-end space-x-4 pt-4 border-t border-gray-800">
              ...
              >
                ...
                {createScheduledPostMutation.isPending ? "Scheduling..." : "Schedule Post"}
              </Button>
            </div>
          </form>
        </div>
