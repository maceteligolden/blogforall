      ...
      <div className="max-w-5xl mx-auto px-6 lg:px-8 py-20">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-400 max-w-3xl mx-auto">
            Have a question, suggestion, or need help? We&apos;d love to hear from you. Send us a message and we&apos;ll
          ...
          <div className="space-y-4">
            <div className="bg-gray-900 rounded-xl border border-gray-800 p-6">
              ...
              <p className="text-gray-400">
                Simply sign up for a free account, create your first blog post, and start publishing! You can upgrade to
                a paid plan anytime to unlock more features.
              </p>
            </div>
            ...
            <div className="bg-gray-900 rounded-xl border border-gray-800 p-6">
              ...
              <p className="text-gray-400">
                Yes! Bloggr provides API access so you can build your own frontend and use your own domain. Your content
                is yours, and you have full control over how it&apos;s displayed.
              </p>
            </div>
            ...
            <div className="bg-gray-900 rounded-xl border border-gray-800 p-6">
              ...
              <p className="text-gray-400">
                We accept all major credit cards and PayPal. All payments are processed securely through our payment
                partners.
              </p>
            </div>
            ...
            <div className="bg-gray-900 rounded-xl border border-gray-800 p-6">
              ...
              <p className="text-gray-400">
                Absolutely! You can cancel your subscription at any time. There are no long-term commitments or
                cancellation fees.
              </p>
            </div>
          </div>
