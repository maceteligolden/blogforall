...
export function IllustrationWorkspace({ className = "", animated = true }: { className?: string; animated?: boolean }) {
  return (
    <IllustrationShell className={className} animated={animated} wide>
      <svg viewBox="0 0 320 200" className="h-full w-full" fill="none" aria-hidden>
        ...
        <rect
          ...
          height="44"
          rx="12"
          className="fill-white/[0.07] stroke-white/12"
          strokeWidth="1"
        />
