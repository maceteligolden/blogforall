...
export function IllustrationDraft({
  className = "",
  animated = true,
}: {
  className?: string;
  ...
  return (
    <IllustrationShell className={className} animated={animated}>
      <svg viewBox="0 0 240 176" className="h-full w-full" fill="none" aria-hidden>
        {/* Document */}
        <rect x="28" y="14" width="140" height="148" rx="12" className="fill-white/[0.06] stroke-white/15" strokeWidth="1" />
        ...
        <g transform="translate(156 36)">
          ...
          <path d="M18 16.5l1.2 3.2 3.3.3-2.5 2.2.8 3.3L18 23.5l-2.8 1.9.8-3.3-2.5-2.2 3.3-.3L18 16.5z" className="fill-white" />
        ...
        <g transform="translate(156 120)">
          ...
          <text x="48" y="18" textAnchor="end" className="fill-primary" fontSize="11" fontFamily="system-ui" fontWeight="700">
            81
          </text>
        </g>
      </svg>
