...
export function IllustrationApi({ className = "", animated = true }: { className?: string; animated?: boolean }) {
  return (
    <IllustrationShell className={className} animated={animated} wide>
      <svg viewBox="0 0 320 200" className="h-full w-full" fill="none" aria-hidden>
        ...
        <rect
          ...
          height="56"
          rx="10"
          className="fill-white/[0.06] stroke-white/10"
          strokeWidth="1"
        />
        <rect
          x="212"
